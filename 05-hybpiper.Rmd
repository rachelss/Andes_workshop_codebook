...
* Read the file `stats_example.csv` in the shared workshop folder using the `read_csv` command.
...
stats_example <- read_csv("../../shared/AndesWorkshop2023/stats_example.csv")
