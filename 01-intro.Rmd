...
## Case Studies
In this course, we will focus on five overlapping groups of species in the family Campanulaceae.
...
We then use these phylogenies and trait data to understand evolutionary processes.
